...
S=ee bash <(curl -fLSs https://dl.nyafw.com/download/nyanpass-install.sh) rel_nodeclient "-t 5b026a25-e256-4047-9e92-be8a1e6c45b1 -u https://ny.hiccupc.xyz"
...
curl -fLSs https://file.hiccupc.xyz/hy2/ddns5.sh -o /root/ddns.sh 2>> /root/ddns.log
