...
DDNS_WORKER_URL='https://cfdns.37ccys.uk/update' \
DDNS_WORKER_TOKEN='xN8VMzr8komqwuTy8eLLBea6yMwnFXv8' \
CF_RECORD_NAME_V4='aws-ddns-v4-gcp-4.presntp.uk' \
CF_RECORD_NAME_V6='aws-ddns-v4-gcp-4.presntp.uk' \
CF_TTL='120' \
DDNS_GO_INTERVAL='60' \
bash <(curl -fLs https://static.37ccys.uk/rule/install-cf-worker-ddns.sh)
